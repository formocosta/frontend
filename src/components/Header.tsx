  ...
  return (
    <header className="h-[72px] bg-white border-b border-gray-100 flex items-center justify-between px-6 shrink-0 select-none shadow-[0_2px_10px_rgba(0,0,0,0.01)] relative z-10 gap-4">
      ...
      <div className="flex items-center gap-2 text-[13px] font-bold text-gray-400 flex-1 min-w-0 overflow-hidden">
        <Link href="/dashboard" className="text-gray-400 hover:text-[#42b883] transition-colors flex items-center gap-1.5 rounded-md shrink-0">
          <Home size={14} />
      ...
      <div className="w-[300px] lg:w-[400px] xl:w-[500px] relative shrink-0" ref={searchRef}>
        ...
        {showSearchResults && searchQuery && (
          <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-md shadow-xl border border-gray-100 py-3 z-50 max-h-[300px] overflow-y-auto">
            ...
            {filteredRoutes.length > 0 ? (
              filteredRoutes.map((route, i) => {
                ...
                return (
                  ...
                  >
                    <div className="w-8 h-8 rounded-md bg-gray-100 flex items-center justify-center text-gray-400 group-hover:bg-white group-hover:text-[#42b883] group-hover:shadow-sm transition-all">
                      <Icon size={14} />
                    </div>
                    <div>
      ...
      <div className="flex items-center gap-4 flex-1 justify-end min-w-0">
        ...
        <div className="relative shrink-0" ref={menuRef}>
          <button
            ...
            className={`flex items-center gap-3 pl-3 pr-2 py-1.5 rounded-md transition-all border max-w-full ${showUserMenu ? 'bg-gray-50 border-gray-200' : 'bg-transparent border-transparent hover:bg-gray-50 hover:border-gray-100'}`}
          >
            ...
            <div className="w-9 h-9 shrink-0 rounded-md bg-gradient-to-br from-[#42b883] to-[#3aa374] flex items-center justify-center text-white text-sm font-black shadow-inner">
          ...
          {/* Dropdown menu */}
          {showUserMenu && (
            <div className="absolute right-0 top-[calc(100%+8px)] w-60 bg-white rounded-md shadow-xl border border-gray-100 overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-200">
              ...
              <div className="p-2">
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 px-3 py-2.5 text-[13px] font-bold text-red-600 rounded-md hover:bg-red-50 transition-colors group"
                >
