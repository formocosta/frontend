      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex-1 flex flex-col justify-between">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 pt-2">
          ...
          <div className="pt-2 flex flex-row items-center justify-center gap-3">
            ...
            <a
              href="#download"
              className="bg-black hover:bg-slate-900 text-white px-4 py-2 rounded-md flex items-center justify-center gap-2.5 shadow-md hover:shadow-lg transition-all active:scale-95 border border-slate-800"
            >
