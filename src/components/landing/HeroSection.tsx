...
export function HeroSection() {
  return (
    <section id="inicio" className="relative h-auto min-h-[calc(100vh-5rem)] lg:h-[calc(100vh-5rem)] pt-8 pb-0 overflow-hidden bg-[#f4f2e6] flex flex-col justify-between">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex-1 flex flex-col justify-between">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 pt-2">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#02562b] tracking-tight leading-[1.15]">
            All-in-one Diet Solution App
          </h1>

          {/* Subtitle / Short Description */}
          <p className="text-base sm:text-lg text-slate-700 font-medium leading-relaxed max-w-xl mx-auto">
            Track your meals, monitor calories, and stay motivated to achieve your health goals.
          </p>
          ...
          <div className="pt-2 flex flex-row items-center justify-center gap-3">
            ...
            >
              ...
              <div className="text-left">
                <div className="text-[9px] uppercase font-semibold text-slate-300 leading-none">GET IT ON</div>
            ...
            >
              ...
              <div className="text-left">
                <div className="text-[9px] uppercase font-semibold text-slate-300 leading-none">Download on the</div>
      ...
      <div className="w-full bg-[#02562b] text-white py-3.5 px-4 mt-4">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-around gap-4 text-base font-semibold tracking-wide">
          <span className="flex items-center gap-2">
            <span className="text-amber-400">●</span> Diet Progress
          </span>
          <span className="flex items-center gap-2">
            <span className="text-amber-400">●</span> Diet Goal
          </span>
          <span className="flex items-center gap-2">
            <span className="text-amber-400">●</span> Easy Track
          </span>
          <span className="flex items-center gap-2">
            <span className="text-amber-400">●</span> Motivation
          </span>
          <span className="flex items-center gap-2">
            <span className="text-amber-400">●</span> Nutrition Advice
          </span>
        </div>
      </div>
    </section>
