...
export default function ClienteDetailPage() {
  ...
  if (loading) {
    return (
      <div className="bg-white rounded-md p-12 shadow-sm border border-gray-100/80 flex flex-col items-center justify-center min-h-[400px]">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-0.5">
                ...
                {cliente.email_verified_at ? (
                  ...
                  <span className="inline-flex items-center gap-1 text-[10px] font-bold text-amber-600 bg-amber-50 px-1.5 py-0.5 rounded-md mt-1">
                    Não verificado
                  </span>
                )}
              </div>
