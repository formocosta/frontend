...
export default function DefinicoesPage() {
  return (
    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100/80 min-h-[400px] flex flex-col justify-center items-center text-center">
      ...
      <h2 className="text-lg font-bold text-gray-900">Definições do Sistema</h2>
      <p className="text-xs text-gray-400 mt-1.5 max-w-sm font-medium">
        Esta página está em desenvolvimento. Brevemente poderá ajustar as configurações gerais da plataforma, permissões de segurança e integrações.
      </p>
    </div>
  );
}
